...
| <a name="provider_juju.wazuh_dashboard"></a> [juju.wazuh\_dashboard](#provider\_juju.wazuh\_dashboard) | ~> 1.0 |
| <a name="provider_juju.wazuh_indexer"></a> [juju.wazuh\_indexer](#provider\_juju.wazuh\_indexer) | ~> 1.0 |
...
| <a name="module_wazuh_indexer"></a> [wazuh\_indexer](#module\_wazuh\_indexer) | git::https://github.com/canonical/wazuh-indexer-operator//terraform/product | rev12&depth=1 |
...
| <a name="input_indexer_consumers"></a> [indexer\_consumers](#input\_indexer\_consumers) | Additional model names that need to consume the indexer offer | `list(string)` | `[]` | no |
...
| <a name="input_self_signed_certificates"></a> [self\_signed\_certificates](#input\_self\_signed\_certificates) | n/a | <pre>object({<br/>    app_name    = optional(string, "self-signed-certificates")<br/>    channel     = optional(string, "1/stable")<br/>    config      = optional(map(string), {})<br/>    constraints = optional(string, "arch=amd64")<br/>    revision    = optional(number)<br/>    base        = optional(string, "ubuntu@22.04")<br/>    units       = optional(number, 1)<br/>    storage     = optional(map(string), {})<br/>  })</pre> | n/a | yes |
...
| <a name="input_wazuh_dashboard"></a> [wazuh\_dashboard](#input\_wazuh\_dashboard) | n/a | <pre>object({<br/>    app_name    = optional(string, "wazuh-dashboard")<br/>    channel     = optional(string, "4.14/edge")<br/>    config      = optional(map(string), {})<br/>    constraints = optional(string, "arch=amd64")<br/>    revision    = optional(number)<br/>    base        = optional(string, "ubuntu@22.04")<br/>    units       = optional(number, 3)<br/>  })</pre> | n/a | yes |
| <a name="input_wazuh_dashboard_grafana_agent"></a> [wazuh\_dashboard\_grafana\_agent](#input\_wazuh\_dashboard\_grafana\_agent) | n/a | <pre>object({<br/>    app_name = optional(string, "grafana-agent")<br/>    channel  = optional(string, "1/stable")<br/>    config   = optional(map(string), {})<br/>    revision = optional(number)<br/>  })</pre> | n/a | yes |
| <a name="input_wazuh_indexer"></a> [wazuh\_indexer](#input\_wazuh\_indexer) | n/a | <pre>object({<br/>    app_name    = optional(string, "wazuh-indexer")<br/>    channel     = optional(string, "4.14/edge")<br/>    config      = optional(map(string), {})<br/>    constraints = optional(string, "arch=amd64")<br/>    revision    = optional(number)<br/>    base        = optional(string, "ubuntu@22.04")<br/>    units       = optional(number, 3)<br/>  })</pre> | n/a | yes |
...
| <a name="input_wazuh_indexer_grafana_agent"></a> [wazuh\_indexer\_grafana\_agent](#input\_wazuh\_indexer\_grafana\_agent) | n/a | <pre>object({<br/>    app_name = optional(string, "grafana-agent")<br/>    channel  = optional(string, "1/stable")<br/>    config   = optional(map(string), {})<br/>    revision = optional(number)<br/>  })</pre> | n/a | yes |
| <a name="input_wazuh_server"></a> [wazuh\_server](#input\_wazuh\_server) | n/a | <pre>object({<br/>    app_name    = optional(string, "wazuh-server")<br/>    channel     = optional(string, "4.14/edge")<br/>    config      = optional(map(string), {})<br/>    constraints = optional(string, "arch=amd64")<br/>    revision    = optional(number)<br/>    base        = optional(string, "ubuntu@22.04")<br/>    units       = optional(number, 1)<br/>    storage     = optional(map(string), {})<br/>  })</pre> | n/a | yes |
